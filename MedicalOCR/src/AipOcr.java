...
public class AipOcr extends BaseClient
{
	 ...
	 *            图片路径
	 * @param options
	 *            接口可选参数 detect_direction : true/false language_type :
	 *            <p>
	 * 			识别语言类型，若不传则默认为CHN_ENG。 可选值包括：CHN_ENG - 中英文混合； ENG - 英文； POR -
	 *            葡萄牙语； FRE - 法语； GER - 德语； ITA - 意大利语； SPA - 西班牙语； RUS - 俄语；
	 *            JAP - 日语
	 *            </p>
	 *            recognize_granularity： big/small mask :
	 *            表示mask区域的黑白灰度图片，白色代表选中, base64编码 detect_language: true/false
	 ...
	 *            图片路径
	 * @param options
	 *            接口可选参数 detect_direction : true/false recognize_granularity：
	 *            big/small detect_language: true/false
	 * @return Json格式的服务器返回值
	 */
	 ...
	 *            图片路径
	 * @param options
	 *            接口可选参数 detect_direction : true/false mask :
	 *            表示mask区域的黑白灰度图片，白色代表选中, base64编码 detect_language: true/false
	 * @return Json格式的服务器返回值
	 */
	 ...
	 *            图片原始文件数据
	 * @param options
	 *            接口可选参数 detect_direction : true/false language_type : mask :
	 *            表示mask区域的黑白灰度图片，白色代表选中, base64编码 detect_language: true/false
	 * @return Json格式的服务器返回值
	 */
	 ...
	 *            JAP - 日语
	 *            </p>
	 *            mask : 表示mask区域的黑白灰度图片，白色代表选中, base64编码 detect_language:
	 *            true/false
	 * @return Json格式的服务器返回值
	 */
	 ...
	 * 
	 * @param requestId
	 *            由tableRecognition接口返回的requestId
	 * @return 识别状态和结果
	 */
	...
	private JSONObject checkParam(byte[] imgData)
	{
		...
		if (width < OcrConsts.OCR_MIN_IMAGE_SIDE_LENGTH || width > OcrConsts.OCR_MAX_IMAGE_SIDE_LENGTH
				|| height < OcrConsts.OCR_MIN_IMAGE_SIDE_LENGTH || height > OcrConsts.OCR_MAX_IMAGE_SIDE_LENGTH)
		{
